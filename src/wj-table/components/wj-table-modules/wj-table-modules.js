...
class WjTableModules extends Module{
    ...
    initializeColumnHeaderPopup(column){
		console.log("wj_table_module","initializeColumnHeaderPopup","start");
...
console.log("wj_table_module","initializeColumnHeaderPopup","finish_1");
        column.titleElement.insertBefore(headerPopupEl, column.titleElement.firstChild);
		console.log("wj_table_module","initializeColumnHeaderPopup","finish_2");
    }
